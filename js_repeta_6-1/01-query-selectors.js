...
console.log('--------------------------------------------');
// Необходимо обратить внимание на то, что при использовании команд "console.log(document)" - в лог выводится HTML структура документа (со всеми тегами и кодом подключеного к соответствующей странице JS скрипта).
