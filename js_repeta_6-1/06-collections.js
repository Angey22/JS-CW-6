...
// Создаем переменную-ссылку на существующий в разметке HTML документа тег - <div> для вставки создаваемых новых элементов
...
// Создаем новую переменную-ссылку и передаем ей в качестве значения результат работы функции "makeColorPickerOptions()" внутрь которой, передаем аргумент в виде исходного массива-объектов  базы данных - "colorPickerOptions".
