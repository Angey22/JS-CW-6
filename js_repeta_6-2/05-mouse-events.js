...
// - 'mouseout' - предназначено для регистрации события, когда курсор мыши уходит с элемента. Отличается от 'mouseleave' тем, что объект события передает не одну, а две ссылки:
