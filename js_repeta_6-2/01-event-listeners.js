 ...
 * - Объект события
 */
// События - это реакция браузера на какоето действие пользователя (например: дрег мышки, нажатие клавиши мышки, скролл мышки, нажатие клавиш на клавиатуре и т.п.) и/или реакция браузера на какое-либо состояние элементов на странице (например: начало и конец действия анимации и т.п.). Любое событие - фиксируется, и отталкиваясь от него, можна активировать выполнение нужного кода (фрагмента скрипта).
...
// 3-й, основан на использовании в имени словосочетания - "on(тип отслеживаемого события)" или "on(где происходит событие)(тип отслеживаемого события)". Например, "onClick" (в переводе с англ. - "при - клике") или "onTargetButtonClick" (в переводе с англ. - "при - целевая кнопка - клике").
